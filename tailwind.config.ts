    ...
    extend: {
      ...
      colors: {
        ...
        section: {
          ...
          card: "hsl(var(--section-card))",
          "card-foreground": "hsl(var(--section-card-foreground))",
          muted: "hsl(var(--section-muted))",
          "muted-foreground": "hsl(var(--section-muted-foreground))",
      ...
      textColor: {
        ...
        "section-muted-foreground": "hsl(var(--section-muted-foreground))",
      },
      borderColor: {
